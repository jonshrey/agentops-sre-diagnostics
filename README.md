...
It uses a LangGraph-based workflow to parse logs, retrieve relevant evidence, detect failure patterns, optionally route to runbook/documentation context, and generate an evidence-grounded incident report.

This project demonstrates practical backend engineering, agentic AI workflow design, SRE-style diagnostics, explainable retrieval, and production-style API design.
...
Retrieve relevant log chunks using:
keyword scoring
severity scoring
time-aware scoring
